import { WebhooksDemo } from "./components/WebhooksDemo";
      ...
      <main className="mx-auto max-w-4xl px-6 py-10">
        ...
        <div className="mt-8 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-zinc-700 dark:text-zinc-300">
            <li>No polling — the other system pushes events to your URL</li>
            <li>Event-driven integrations (payments, CI, etc.)</li>
          </ul>
          <h2 className="mt-4 text-sm font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">
            Tradeoffs
          </h2>
          <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-zinc-700 dark:text-zinc-300">
            <li>You must expose a public endpoint and handle retries/security</li>
          </ul>
